...
/**
 * Static environment of key-value pairs that allows tests to exchange test parameters across
...
public class ConTestEnvironment {
     ...
     *
     * @param key The parameter's key.
     * @return The parameter's value, if the parameter exists in the global scope, otherwise null.
     */

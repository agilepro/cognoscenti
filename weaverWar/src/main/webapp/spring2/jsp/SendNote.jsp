...
<%@include file="ErrorPanel.jsp"%>
    <div class="row m-1 g-3 align-items-center form-group" ng-show="emailInfo.state==1">
        <div class="col-1 ms-auto">
            <label for="showAddressingOptions" class="col-form-label">Roles</label>
        </div>
        <div class="col-8 me-auto">
            <button class="btn-secondary btn-raised " ng-click="showAddressingOptions=!showAddressingOptions">
                <i class="fa fa-plus"></i>&nbsp;&nbsp;Click here to see addressing options
            </button>
        </div>
    </div>
          
    <div class="row m-1 g-3 align-items-center form-group" ng-show="showAddressingOptions">
        <div class="container-fluid col-12">
            <span class="col-auto ms-3">
                <h3>Roles</h3>
            </span>
            <div class="col-auto me-auto">
                <div ng-repeat="role in allRoles" >
                    <button class="btn-secondary btn-raised" ng-click="addPlayers(role)">
            ...
            <div class="col-md-5">
                <div ng-show="meeting.participants">
                    ...
                    <div>
                        <button class="btn-secondary btn-raised" ng-click="addMeetingInvitees()" title="Add all the people invited to the meeting">Add Meeting Invitees</button>
                    </div>
                    <div>
                        <button class="btn-secondary btn-raised" ng-click="addMeetingAttendees()" title="Add all the people who attended the meeting">Add Meeting Attendees</button>
                    </div>
                    <div>
                        <button class="btn-secondary btn-raised" ng-click="addMeetingNoShows()" title="Add all the people invited but did not show up">Add Meeting No-shows</button>
                    </div>
                </div>
                <div ng-show="emailInfo.noteInfo.subscribers">
                    <h3>Topic Subscribers</h3>
                    <button class="btn-secondary btn-raised" ng-click="addTopicSubscribers()" title="Add all the people invited to the meeting">Add All Subscribers</button>
                </div>
                <div>
                    <h3>Clear</h3>
                    <button class="btn-secondary btn-raised" ng-click="emailInfo.alsoTo = []" title="Add all the people invited to the meeting">Clear Addressees</button>
                </div>
            </div>
        </div>
    </div>

    <div class="row m-1 g-3 align-items-center form-group">
        <div class="col-1 ms-auto">
            <label class="col-form-label" for="alsoalsoTo">Send To</label>
        </div>
        <div class="col-8 me-auto">
    ...
    <div class="row m-1 g-3 align-items-top form-group">
        <div class="col-1 ms-auto">
...
<br/>
    <div class="row m-1 g-3 align-items-top form-group" ng-dblclick="openAttachDocument()">
        <div class="col-1 ms-auto">
            <label class="col-form-label labelColumn" ng-click="openAttachDocument()">Attachments</label>
        </div>
        <div class="col-8 me-auto">
    ...
    <div class="row m-1 g-3 align-items-top form-group" style="width:100%" ng-click="emailInfo.attachFiles=!emailInfo.attachFiles" >
        <div class="col-1 ms-auto">
            <label class="col-form-label">Type:</label>
        </div>
        <div class="col-8 me-auto">
            <div style="padding:10px;">
                <input type="checkbox" ng-model="emailInfo.attachFiles"/>  Include attachment data directly in the email (unsafe)
            </div>
        </div>
    </div>

    <div class="row m-1 g-3 align-items-top form-group form-inline" ng-show="emailInfo.meetingInfo.name">
<hr/>
        <div class="col-1 ms-auto">
            <label class="col-form-label">Meeting</label>
        </div>
        <div class="col-8 me-auto">
            <span class="btn btn-sm btn-default btn-raised">{{emailInfo.meetingInfo.name}}</span>Layout: 
            <select class="form-control"  ng-model="emailInfo.meetingLayout" ng-options="n for n in allLayoutNames"></select>
        </div>
    </div>

    <div class="row m-1 g-3 align-items-top form-group" ng-show="emailInfo.noteInfo.subject">
<hr/>    
        <div class="col-1 ms-auto">      
            <label class="col-form-label">Discussion Topic</label>
        </div>
        <div class="col-8 me-auto">
    ...
    <div class="row m-1 g-3 align-items-top form-group">
        ...
        <div class="col-8 me-auto d-flex g-3">
            <span class="btn-raised form-control w-25 ms-2" ng-click="emailInfo.tasksOption='None'">
                <input type="radio" ng-model="emailInfo.tasksOption" value="None"> None &nbsp 
            </span>
            <span class="btn-raised form-control w-25 ms-2" ng-click="emailInfo.tasksOption='Assignee'">
                <input type="radio" ng-model="emailInfo.tasksOption" value="Assignee"> Only to Assignee &nbsp 
            </span>
            <span class="w-50 btn-raised form-control ms-2" ng-click="emailInfo.tasksOption='All'">
    ...
    <div class="row m-1 g-3 align-items-top form-group" ng-show="suppressEmail">
        <div class="col-1 ms-auto">
            <label class="col-form-label">Suppression:</label>
        </div>
    ...
    <div class="row">
        <div class="d-flex col-8 ms-auto">
            <button ng-click="deleteEmail()" class="btn btn-danger btn-raised ms-auto" ng-hide="emailInfo.id=='~new~'">Delete</button>
            <button ng-click="saveEmail()" class="btn btn-primary btn-raised ms-2">Save &amp; Preview</button>
            <button ng-click="sendEmail()" class="btn btn-primary btn-raised ms-2" ng-show="suppressEmail">Simulate Sending</button>
            <button ng-click="sendEmail()" class="btn btn-primary btn-raised ms-2" ng-hide="suppressEmail">Send Now</button>
        </div>
    </div>
</div>
...
<div class="row m-1 g-3 align-items-center form-inline">
    <div class="col-1 ms-2">
        <label class="col-form-label">For Recipient</label>
    </div>
    <div class="col-6 me-auto d-flex g-3">
        <select class="form-control" ng-model="recipient" ng-options="rec as rec.name for rec in recipientList track by rec.uid"></select>
        <button ng-click="getRenderedEmail()" class="ms-2 btn btn-primary btn-raised">Preview Email</button>
    </div>
</div>
    <div class="instruction success ms-3">This is what the email will look like:<br/><br/></div>

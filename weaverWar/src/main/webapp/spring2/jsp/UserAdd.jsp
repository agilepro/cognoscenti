...
app.controller('myCtrl', function($scope, $http, $modal, AllPeople) {
    ...
    $scope.doSearch = function() {
        ...
        $scope.foundPerson = AllPeople.findPerson($scope.newEmail, $scope.siteInfo.key);
        console.log("PERSON", $scope.foundPerson);
    ...
    $scope.doCreate = function() {
        ...
        .success( function(data) {
            console.log("CREATE RETURNED: ", data);
...
<% } else { %>
    ...
    <div class="well col-12 m-2" ng-show="wizardStep < 1">
        ...
        <div ng-show="wizardStep < 1">
            <button ng-click="doSearch()" class="btn btn-primary btn-wide btn-raised">Search</button>
        </div>
    </div>
    ...
    <div class="well col-12 m-2" ng-show="wizardStep>2">
        <div class="row d-flex my-3">
            ...
            <span class="col-10" ng-repeat="id in foundPerson.ids">{{id}}  </span>
    ...
    <div class="well col-12 m-2" ng-show="wizardStep==3">
        <span class="h6"><i>Person exists in Weaver, what role should they be in?</i></span>
        ...
        <div>
            <button ng-click="doAssignRole()" class="btn btn-primary btn-wide btn-raised">Assign to Role</button>
        </div>
    </div>      

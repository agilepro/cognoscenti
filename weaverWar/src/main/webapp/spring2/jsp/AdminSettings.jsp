...
<% } %>-->
    ...
    <div>
        ...
        <div>
            <div class="table m-2">
                <div class="row m-2" >
                    <span ng-click="setEdit('name')" class="col-1 fixed-width-sm h5 bold labelColumn">Workspace Name:</span>
                    <span class="col-10" ng-hide="isEditing=='name'" ng-dblclick="setEdit('name')">
                        <h2 class="h4">{{workspaceConfig.allNames[0]}}</h2>
                    </span>
                    <span class="col-10 form-inline form-group" ng-show="isEditing=='name'">
                ...
                <div class="row m-2">
                    <span ng-click="setEdit('vision')" class="col-1 fixed-width-sm h5 bold labelColumn mt-2">Vision:</span>
                    <span class="col-10" ng-hide="isEditing=='vision'" ng-dblclick="setEdit('vision')">
                        ...
                        <span class="col-10 form-inline form-group" ng-show="isEditing=='vision'">
                ...
                <div class="row m-2">
                    <span class="col-1 h5 bold fixed-width-sm labelColumn mt-2" ng-click="setEdit('mission')">Mission:</span>
                    <span class="col-10" ng-hide="isEditing=='mission'" ng-dblclick="setEdit('mission')">
                    ...
                    <span class="col-10 form-inline form-group" ng-show="isEditing=='mission'">
                ...
                <div class="row m-2" >
                    <span class="col-1 h5 bold fixed-width-sm labelColumn mt-2" ng-click="setEdit('purpose')" >Aim:</span>
                    <span class="col-10" ng-hide="isEditing=='purpose'" ng-dblclick="setEdit('purpose')">
                    ...
                    <span class="col-10 form-inline form-group" ng-show="isEditing=='purpose'">
                ...
                <div class="row m-2">
                    <span class="col-1 h5 bold fixed-width-sm labelColumn mt-2" ng-click="setEdit('domain')" >Domain:</span>
                    <span class="col-10" ng-hide="isEditing=='domain'" ng-dblclick="setEdit('domain')">
                    ...
                    <span class="col-10 form-inline form-group" ng-show="isEditing=='domain'">
                ...
                <div class="row m-2">
                    <span ng-click="setEdit('frozen')" class="col-1 h5 bold fixed-width-sm labelColumn mt-2">Workspace State:</span>
                    <span class="col-10 mt-3 fs-5 bold" ng-hide="isEditing=='frozen'" ng-dblclick="setEdit('frozen')">
                    ...
                    <span class="col-10" ng-show="isEditing=='frozen'">
                ...
                <div class="row m-2">
                    <span ng-click="setEdit('parentKey');backupParent=parentWorkspace" class="col-1 h5 bold fixed-width-sm labelColumn mt-2">Parent Circle:</span>
                    <span class="col-10" ng-hide="isEditing=='parentKey'" ng-dblclick="setEdit('parentKey');backupParent=parentWorkspace">
                        <div>{{parentWorkspace.name}}</div>
                        <div ng-hide="workspaceConfig.parentKey" class="clicker"></div>
                    </span>
                    <span class="col-10" ng-show="isEditing=='parentKey'">
                        <table>
                            <tr>
                            <td>Filter: </td>
                ...
                <div class="row m-2">
                    <span class="col-1 h5 bold fixed-width-sm labelColumn" span ng-click="toggleBool('suppressEmail')">Email</span>
                    <span class="col-10">

        ...
        <ul class="dropdown-menu" aria-labelledby="dropdownInfoMenu">
            <li>
                ...
                <span class="dropdown-item" type="button" ng-click="openTopicCreator()"
                    aria-labelledby="createNewTopic"><a class="nav-link" role="menuitem" href="EmailCreated.htm"> Email
                        Prepared</a>
                </span>
                <span class="dropdown-item" type="button" ng-click="openTopicCreator()"
                    aria-labelledby="createNewTopic"><a class="nav-link " role="menuitem" href="SendNote.htm"> Create
                        Email</a>
                </span>
                <span class="dropdown-item" type="button" ng-click="openTopicCreator()"
                    aria-labelledby="createNewTopic"><a role="menuitem" class="nav-link" href="AdminSettings.htm"> Admin
                        Settings</a>
                </span>
            </li>
        </ul>

...
<div class="card" id="cardparticipants">
    ...
    <div class="col-12">
    <div class="row-cols-7 d-flex border-opacity-25 border-bottom border-secondary ms-4">
        <span class="col-1 h6">  </span>
        <span class="col-3 h6" title="Name of the participant">Name</span>
        <span class="col-1 h6" title="Click on these to record whether the user attended or not">Attended</span>
        <span class="col-1 h6" title="Shows whether the user is expected to be there or not">Expected</span>
        <span class="col-2 h6" title="Shows the user explanation of whether they will attend or not">Situation</span>
        <span class="col-1 h6" title="Shows what the user selected during the time selection phase, if anything">Avail</span>
        <span class="col-1 h6" title="Shows an indicator when this person is online and has accessed meeting in last 30 minutes">On</span>
    </div>
    <div class="row-cols-7 d-flex form-inline form-group my-3 ms-4" ng-repeat="(key, pers) in meeting.people">
        ...
        <span class="col-3" style="overflow:hidden;white-space:nowrap" title="Click on these to record whether the user attended or not">
          {{pers.name}}
        </span>
        <span class="col-1" ng-click="toggleAttend(pers)" title="Click on these to record whether the user attended or not">
        ...
        <span class="col-1" ng-dblclick="toggleEditSitch(pers)" title="Shows whether the user is expected to be there or not">
        ...
        <span class="col-2"  ng-dblclick="toggleEditSitch(pers)" title="Shows the user explanation of whether they will attend or not">
        ...
        <span class="col-1" title="Shows what the user selected during the time selection phase, if anything">
        ...
        <span class="col-1" title="Shows an indicator when this person is online and has accessed meeting in last 30 minutes">

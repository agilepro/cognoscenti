...
<div class="col-8 well ms-5">Filter <input ng-model="filter"></div>
    ...
    <div class="container-fluid override col-8 ms-5">
    ...
    <div class="guideVocal" ng-show="noneFound">
        <span class="h5">User <% uProf.writeLink(ar); %> has not created any workspaces, and does not have any access to sites to create one in.</span><br/>
       <br/>
    <span class="h6 mx-3">When a user creates workspaces, they will be listed here.</span><br/>
       <br/>
    ...
    <span class="h6 mx-3">Use <button class="no-btn" onClick="location.href='userSites.htm'"><img src="<%=ar.retPath%>new_assets/assets/navicon/UserSiteAdmin.png" style="max-height:35px;max-width:35px"></button>
       to view your sites, or request a new site from the system administrator here: </span>
       <form name="createAccountForm" method="GET" action="NewSiteRequest.htm">
        <input type="submit" class="btn btn-primary btn-wide btn-raised my-3 float-end"  Value="Request New Site">

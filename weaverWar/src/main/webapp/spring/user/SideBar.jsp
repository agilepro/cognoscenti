...
<!-- Side Bar -->
<nav class="navbar navbar-default navbar-fixed-side sidebar navbar-responsive-collapse special-user-sidebar" role="navigation" style="background-color: #39134C">
  <ul>
    <% 

...
public class JsonUtil {
    ...
    public static <T extends Object> T loadOrCreateJsonFile(File filePath, Class<T> childClass)
            throws Exception {
        if (!filePath.exists()) {
    ...
    public static <T extends Object> T loadJsonFile(File filePath, Class<T> childClass)
            throws Exception {
        try {
            if (!filePath.exists()) {
                throw WeaverException.newBasic(

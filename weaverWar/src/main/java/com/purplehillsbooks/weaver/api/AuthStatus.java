...
public class AuthStatus {
    ...
    /**
     * Generates a value based on the current time, and the time of the previous id generation, but
     * checking also that it has not given out this value before. If a key has already been given
     * out for the current time, it increments by one. This method works as long as on the average
     * you get less than one ID per millisecond.
     */

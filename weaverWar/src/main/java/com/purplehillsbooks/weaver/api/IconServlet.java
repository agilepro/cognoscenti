...
/**
 * This servlet services up an image for use as an icon Any address of the type /icon/xxxxxxxx.jsp
 * will return an image The xxxxxxxx is either a user key or an email address
 */
...
public class IconServlet extends jakarta.servlet.http.HttpServlet {
    ...
    private File findMatchingImage(String fileName) throws Exception {
        if (!fileName.endsWith(".jpg")) {
            ...
            throw CommonException.newBasic("Icon file must be a '.jpg' file, not %s", fileName);
        }
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse resp) {
        ...
        try {
            ...
            if (pos < 0) {
                ...
                throw CommonException.newBasic("path does not have 'icon'");
            }

...
/**
 * A meeting can have a set of proposed times. People can then indicate when they want to meet. From
 * that, you can set the meeting time
 */
public class MeetingProposeTime extends DOMFace {
    ...
    /** find a person and set their value. set to 0 to remove person from the list. */

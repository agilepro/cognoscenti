 ...
 * give the requester the information that is specified as being allowed in the license. Initially a
 * license will be used to give non-authenticated users access to a single page or to just the

...
/**
 * this class contains all the JSON style REST web service requests because error handling is
 * defined on a class basis, and we need correct error handling for JSON requests.
 */
@Controller
public class JSONController extends BaseController {
    ...
    public static void sendJSONResponse(AuthRequest ar, String responseMessage) throws IOException {

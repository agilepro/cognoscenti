...
public class ProcessRecord extends BaseRecord {
    ...
    /**
     * Generates a fully qualified, licensed, Wf-XML link for this process This is the link someone
     * else would use to get to this process. AuthRequest is needed to know the current server
     * context path
     *
     ...
     */
    public LicensedURL[] getLicensedParents() throws Exception {
    ...
    /** the ID is missing */
    public HistoryRecord createPartialHistoryRecord() throws Exception {
        DOMFace historyContainer = requireChild("history", DOMFace.class);

...
/**
 * Hold the address of a recipient along with the REASON that the person is receiving the email, so
 * that we can generate a line of output that has a link to Opt out such emailing in the future.
 */

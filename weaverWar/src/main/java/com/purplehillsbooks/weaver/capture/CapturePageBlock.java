...
public class CapturePageBlock {
    ...
    /**
     * we have determined that this block just contains a bunch of links and is probably just a menu
     * or navigation section
     */
    public static final int MENUNAVBLOCK = 2;

...
public class CapturePage {
    ...
    public static CapturePage consumeWebPage(Writer wr, String path, String cleaner)
            throws Exception {
        ...
        try {
            ...
            if (!contentType.contains("text/html")) {
                sp.errorMessage =
                        "Sorry, this attachment has a content type of "
                                + contentType
                                + ", not HTML text.   Can only show the text of HTML pages.";
            } else {
    ...
    /**
     * 1 = not a block instead span or text style, 2 == leaf block, 3 == containing block, 0 ==
     * unknown
     */
    ...
    public void produceHtml(Writer w) throws Exception {
        if (errorMessage != null) {
            ...
            w.write("\n</b></p>");
            w.write(
                    "\n<p>You can access the original web resource with <a href=\""
                            + fullUrl
                            + "\">THIS LINK</a></p>");
        } else {
            int i = 0;

...
public class AdminEvent extends DOMFace {
    ...
    /**
     * This is the ID of the object being referred to. If this is a user registration, then this is
     * the key of the user profile. If this is a site creation, then this holds the key to the site.
     */
    ...
    /**
     * Set the user who modifed the record, and the time of modification at the same operation,
     * because both should be set at the same time
     */

...
%><%
    ...
    Vector<NGPageIndex> ownedProjs = ar.getCogInstance().getProjectsUserIsPartOf(uProf);
...
<%@include file="ErrorPanel.jsp"%>
    ...
    <div class="generalHeading" style="height:40px">
        <div  style="float:left;margin-top:8px;">
            Projects <% ar.writeHtml(uProf.getName()); %> plays a role in
        </div>
              ...
              <div class="dropdown">
                ...
                <ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
                  <li role="presentation">
                      <a role="menuitem" tabindex="-1" href="<%=ar.retPath%>t/{{rec.siteKey}}/{{rec.pageKey}}/notesList.htm">Access Project</a></li>
                  <li role="presentation">

...
*/
    ...
    NGContainer ngb =ar.getCogInstance().getSiteByIdOrFail(accountId);
    ...
    if (isNew) {
        ...
        CustomRole role = (CustomRole) ngb.getRoleOrFail(roleName);
...
/*   PROTOTYPE
    ...
    $scope.roleInfo = {
      "color": "yellow",
      "description": "Members of a workspace can see and edit any of ",
      "expandedPlayers": [
        {
          "name": "Keith Swenson",
...
app.controller('myCtrl', function($scope, $http) {
    ...
    $scope.updateRole = function() {
        ...
        .success( function(data) {
            if ($scope.isNew) {
                window.location="EditRoleBook.htm?roleName="+data.name;
            }
            $scope.roleInfo = data;
        })

        ...
        <form name="requestNewAccount" action="<%=ar.retPath%>v/<%ar.writeHtml(uProf.getKey());%>/accountRequests.form" method="post">
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td><input type="text" name="accountName" id="accountName" class="form-control" /><br/>
                ...
                <tr>
                    ...
                    <td style="width:20px;"></td>
                    <td><input type="text" name="accountID" id="accountID" class="form-control"/><br/>
                ...
                <tr>
                    ...
                    <td style="width:20px;"></td>
                    <td><textarea name="accountDesc" id="accountDesc" class="form-control" rows="4"></textarea><br/>
